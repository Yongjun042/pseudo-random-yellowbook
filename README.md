...
| [C++](#C++) | `<random>` | (mt19937...) | |
| [C#](#C#) |[`System`](https://docs.microsoft.com/ko-kr/dotnet/api/system?view=net-5.0)|[`new Random().Next(1, 11)`](https://docs.microsoft.com/ko-kr/dotnet/api/system.random?view=net-5.0)|[`new Random().NextDouble() * 100`](https://docs.microsoft.com/ko-kr/dotnet/api/system.random.nextdouble?view=net-5.0)|
| Visual Basic |
